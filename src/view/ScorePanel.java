...
public class ScorePanel extends JPanel implements Observer {
    ...
    public void paintComponent(final Graphics theGraphic) {
        ...
        g2d.setFont(new Font("TimesRoman", Font.BOLD, FONT));
        
        g2d.drawString("Level: " + myLevel, X_INIT, Y_INIT);
        g2d.drawString("Score: " + myScore, X_INIT, Y_INIT + X_INIT * 2);
        g2d.drawString("Lines: " + myLines, X_INIT,  Y_INIT + X_INIT * 2 * 2);
